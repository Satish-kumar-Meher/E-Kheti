...
export const Login = () => {
    ...
    const signupHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('http://localhost:9000/ekheti/v1/user/login', input, {
                headers: {
            ...
            console.log(error);
            toast.error("Fill up the input properly");
        } finally {
            setLoading(false);
        }
    }
    ...
    const handleGoogleAuth = () => {
        try {
            window.location.href = "http://localhost:9000/ekheti/v1/g-auth/google/callback"
